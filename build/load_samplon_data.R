## load samplon2a
sam <- read.csv2(file="./data/samplon2a_extra_kolom_tot_meerdere_huishoudens.csv", na.strings="#LEEG!", colClasses=c("numeric", "factor", "factor", "factor", "numeric", "factor", "numeric", "factor", "numeric", "numeric"))
...
## load samplon2r1 
reg_t1 <- read.csv2(file="./data/samplon2r1.csv", na.strings="#LEEG!", colClasses=c("factor", "factor", "numeric", "numeric"))
...
## load samplon2r2 
reg_t2 <- read.csv2(file="./data/samplon2r2.csv", na.strings="#LEEG!", colClasses=c("factor", "factor", "numeric", "numeric"))
